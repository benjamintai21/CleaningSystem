...
//     //     public List<UserAccount> searchUserAccount() { return List.of(); }
...
//     //     // public UserProfile viewUserProfile(int profileId) { return new UserProfile(); }
...
//         mockProfile.setProfileName(name);
//         mockProfile.setDescription(description);
//         mockProfile.setSuspended(suspended);
...
//         when(viewUserProfileController.viewUserProfile(profileId)).thenReturn(mockProfile);
